...
async def test_task_plain_value_wraps_in_operation_result():
...
async def test_task_passthrough_when_returns_operation_result():
...
async def test_task_captures_exception_as_failed_result():
