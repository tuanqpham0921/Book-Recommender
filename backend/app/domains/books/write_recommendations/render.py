...
Interpretation of upstream shapes is the consuming node's own job (rule 4 in
...
PROMPT_PATH = "domains/books/write_recommendations/prompts/write_recommendations.txt"
